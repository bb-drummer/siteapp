...
var siteappDocs = require('foundation-docs');
...
var PANINI_CONFIG = {
  ...
  helpers: siteappDocs.handlebarsHelpers,
}
...
supercollider
  .config({
    template: siteappDocs.componentTemplate,
    marked: siteappDocs.marked,
    handlebars: siteappDocs.handlebars,
    keepFm: true,
    quiet: false,
    pageRoot: 'docs/pages',
    data: {
...
gulp.task('docs:debug', gulp.series(['docs:all', function(cb) {
